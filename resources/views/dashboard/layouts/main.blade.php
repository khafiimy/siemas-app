...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="/db/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <link rel="stylesheet" href="/db/assets/vendor/css/custom.css" />
    ...
    <link rel="stylesheet" href="/db/assets/vendor/libs/apex-charts/apex-charts.css" />
    ...
    <link rel="stylesheet" type="text/css" href="/db/assets/vendor/css/dataTables.bootstrap4.min.css" />
...
<body>
    ...
    <!-- Vendors JS -->
    <script src="/db/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="/db/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="/db/assets/js/dashboards-analytics.js"></script>

    <!-- Place this tag in your head or just before your close body tag. -->
    <script async defer src="https://buttons.github.io/buttons.js"></script>

    <script type="text/javascript" src="/db/assets/vendor/js/jquery-3.5.1.js"></script>
    <script type="text/javascript" src="/db/assets/vendor/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="/db/assets/vendor/js/dataTables.bootstrap4.min.js"></script>
