...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="basic-default-phone">Catatan</label>
                        <div class="col-sm-9">
                            <p class="t-detail">: {{$pengaduan->catatan_pengaduan}}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row mt-3">
        <div class="col-md-8 d-flex justify-content-end">
            <form action="/pengaduan-konfirmasi-{{$pengaduan->id}}" method="POST">
                @csrf
                @method('put')
            ...
            <div class="modal fade" id="basicModal2" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form action="/pengaduan-hasil-{{$pengaduan->id}}" method="POST">
                        @csrf
                        @method('put')
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="row g-2 mt-2">
                                    <div class="col mb-0">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="hasil"
                                            rows="3">{{$pengaduan->hasil_pengaduan}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
