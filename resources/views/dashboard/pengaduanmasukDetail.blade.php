...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengaduan /</span> Detail Pengaduan Masuk</h4>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col mb-3">
                                                ...
                                                @if ($dokumentasi->video != null)
                                                <video width="320" height="240" controls>
                                                    <source src="/storage/dokumentasi_pengaduan/{{$dokumentasi->video}}"
                                                        type="video/mp4">
    ...
    <div class="row mt-3">
        <div class="col-md-8 d-flex justify-content-end">
            <form action="/pengaduan-hapus-{{$pengaduan->id}}" method="POST">
                @csrf
                @method('delete')
                                ...
                                <div class="row g-2 mt-2">
                                    <div class="col mb-0">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="catatan"
                                            rows="3" placeholder="Masukan catatan..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
